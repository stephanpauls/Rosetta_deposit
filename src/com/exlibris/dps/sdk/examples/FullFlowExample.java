...
public class FullFlowExample {
	...
	static final String subDirectoryName = "/DepositExample5";

	static final String PDS_URL = "http://libis-t-rosetta-1.libis.kuleuven.be:8991/pds";
	static final String DEPOSIT_WSDL_URL = "http://libis-t-rosetta-1.libis.kuleuven.be:1801/dpsws/deposit/DepositWebServices?wsdl ";
	static final String PRODUCER_WSDL_URL = "http://libis-t-rosetta-1.libis.kuleuven.be:1801/dpsws/deposit/ProducerWebServices?wsdl";
	static final String SIP_STATUS_WSDL_URL = "http://libis-t-rosetta-1.libis.kuleuven.be:1801/dpsws/repository/SipWebServices?wsdl";

	static final String folder_on_working_machine = "C:/dps-sdk-2.2.0/dps-sdk-projects/dps-sdk-deposit/data/depositExamples/";
	static final String filesRootFolder = folder_on_working_machine + subDirectoryName +"/content/streams/";
	static final String IEfullFileName = folder_on_working_machine + subDirectoryName + "/content/ie1.xml";
